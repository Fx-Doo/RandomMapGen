	...
	function gadget:Initialize()
		...
		for x = 0,Game.mapSizeX, minDistance do
			for z = 0,Game.mapSizeZ, minDistance do
				...
				if y > minTreeHeight and y < maxTreeHeight and math.random(1,getHeightDensity(y,invDensity)) == 1 and Spring.TestMoveOrder(UnitDefNames.armstump.id, x, y, z) == true then
					ctTrees = ctTrees + 1
